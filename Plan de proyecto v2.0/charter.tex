...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en desarrollar y evaluar un modelo de predicción de series de tiempo basado en técnicas de deep learning, para su aplicación en problemas demográficos relevantes. El trabajo tendrá un presupuesto preliminar estimado de 600 horas de trabajo, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
